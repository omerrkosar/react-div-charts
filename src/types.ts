...
export interface BarChartProps {
  ...
  renderBarContainer?:(value:CellData,chartMaxValue:number,cellWidth:number)=>React.ReactNode;
  renderBar?:(value:CellData,cellWidth:number)=>React.ReactNode;
  renderLabel?:(label:string,cellWidth:number)=>React.ReactNode;
  renderLabels?:(cellWidth:number)=>React.ReactNode;
}
...
export interface LineChartProps {
  ...
  renderLineContainer?:(value:CellData,chartMaxValue:number,cellWidth:number,nextData?:CellData)=>React.ReactNode;
  renderLine?:(value:CellData)=>React.ReactNode;
